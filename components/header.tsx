...
export function Header() {
  ...
  return (
    <header className="sticky top-0 z-40 bg-white/95 backdrop-blur border-b border-[#e4ebe6]">
      <div className="container h-16 flex items-center gap-3 md:gap-4">
        <Link href="/" aria-label="Lumagada — Lu Mau Gue Ada" className="shrink-0 flex items-center">
          <img src="/lumagada-logo.svg" alt="Lumagada — Lu Mau Gue Ada" className="w-[126px] sm:w-[142px] h-[52px] sm:h-[58px] object-contain" />
        </Link>
      ...
      {open && (
        <div id="mobile-menu" className="md:hidden border-t border-[#e4ebe6] bg-white shadow-lg">
